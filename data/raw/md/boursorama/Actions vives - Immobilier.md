...
|---|---|---|---|---|---|---|
| `FR0000121964` | KLEPIERRE | n.c. | n.c. | 20,46% | n.c. | non renseignée |
| `FR0013326246` | UNIBAIL RODAMCO WESTFIELD | n.c. | n.c. | 26,60% | n.c. | non renseignée |

---
## KLEPIERRE

`FR0000121964` · n.c. · Action · SFDR non renseignée
...
| Classification d'actif | Immobilier (annexe IB SwissLife (par ISIN)) |
...
| Nette de l'unité de compte (C = A − B) | 21,37% |
| **Finale (A − E)** | **20,46%** |
...
`FR0013326246` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | 27,56% |
| **Finale (A − E)** | **26,60%** |
