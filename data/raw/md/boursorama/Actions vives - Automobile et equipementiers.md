...
type_actif: "Automobile et équipementiers"
slug: actions-vives--automobile-et-equipementiers
...
| `FR001400AJ45` | MICHELIN | n.c. | n.c. | -11,64% | n.c. | non renseignée |
| `FR0000131906` | RENAULT | n.c. | n.c. | -25,28% | n.c. | non renseignée |
| `NL00150001Q9` | STELLANTIS NV | n.c. | n.c. | -26,21% | n.c. | non renseignée |
| `FR0013176526` | VALEO | n.c. | n.c. | 24,01% | n.c. | non renseignée |
...
| Nette de l'unité de compte (C = A − B) | 11,65% |
| **Finale (A − E)** | **10,82%** |
...
`NL0011585146` · n.c. · Action · SFDR non renseignée

### Identité

| | |
|---|---|
| Code ISIN | `NL0011585146` |
| Société de gestion | n.c. |
| Nature juridique | Action |
| Classification SFDR | non renseignée |
| Avenant spécifique | non |
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -22,72% |
| **Finale (A − E)** | **-23,30%** |
...
`FR0000121147` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | 56,91% |
| **Finale (A − E)** | **55,74%** |
...
`FR001400AJ45` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -10,98% |
| **Finale (A − E)** | **-11,64%** |
...
`FR0000131906` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -24,72% |
| **Finale (A − E)** | **-25,28%** |
...
`NL00150001Q9` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -25,66% |
| **Finale (A − E)** | **-26,21%** |
...
`FR0013176526` · n.c. · Action · SFDR non renseignée

### Identité

| | |
|---|---|
| Code ISIN | `FR0013176526` |
| Société de gestion | n.c. |
| Nature juridique | Action |
| Classification SFDR | non renseignée |
| Avenant spécifique | non |
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | 24,95% |
| **Finale (A − E)** | **24,01%** |
...
`DE0007664039` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | 16,30% |
| **Finale (A − E)** | **15,42%** |
