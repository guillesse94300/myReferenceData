...
type_actif: "Actions Zone Euro Petites Capitalisations"
slug: actions--actions-zone-euro-petites-capitalisations
...
supports:
  - isin: "FR0010546903"
    nom: "ECHIQUIER SMID BLEND EUR SRI C"
    ...
    retrocessions: "0,88%"
  - isin: "FR0010689141"
    nom: "LAZARD SMALL CAPS EURO SRI R"
...
# Actions — Actions Zone Euro Petites Capitalisations
...
|---|---|---|---|---|---|---|
| `FR0010546903` | ECHIQUIER SMID BLEND EUR SRI C | FINANCIERE DE L ECHIQUIER | 2,87% | 16,55% | 0,88% | Article 8 |
| `FR0010689141` | LAZARD SMALL CAPS EURO SRI R | LAZARD FRERES GESTION SAS | 3,23% | 16,74% | 1,20% | Article 8 |

---
## ECHIQUIER SMID BLEND EUR SRI C

`FR0010546903` · FINANCIERE DE L ECHIQUIER · FCP · SFDR Article 8
...
| Classification d'actif | Actions Zone Euro Petites Capitalisations (annexe IA SwissLife (par ISIN)) |
...
| Niveau | Taux |
|---|---|
| Brute de l'actif (A) | 19,42% |
| Nette de l'unité de compte (C = A − B) | 17,43% |
| **Finale (A − E)** | **16,55%** |
...
`FR0010689141` · LAZARD FRERES GESTION SAS · SICAV · SFDR Article 8
...
| Poste | Taux |
|---|---|
| Frais de gestion de l'actif (B) | 2,35% |
| Frais de gestion du contrat (D) | 0,75% |
| **Frais totaux (E = B + (1 + C) × D)** | **3,23%** |
| Taux de rétrocession de commissionnement | 1,20% |

### Performances du dernier exercice clos

| Niveau | Taux |
|---|---|
| Brute de l'actif (A) | 19,98% |
| Nette de l'unité de compte (C = A − B) | 17,63% |
| **Finale (A − E)** | **16,74%** |
