...
|---|---|---|---|---|---|---|
| `FR0000125338` | CAP GEMINI | n.c. | n.c. | -10,73% | n.c. | non renseignée |
| `FR0014003TT8` | DASSAULT SYSTEMES | n.c. | n.c. | -29,37% | n.c. | non renseignée |
| `DE0007164600` | SAP | n.c. | n.c. | -12,49% | n.c. | non renseignée |

---
## CAP GEMINI

`FR0000125338` · n.c. · Action · SFDR non renseignée
...
| Classification d'actif | Logiciels et services informatiques (annexe IB SwissLife (par ISIN)) |
...
| Nette de l'unité de compte (C = A − B) | -10,05% |
| **Finale (A − E)** | **-10,73%** |
...
`FR0014003TT8` · n.c. · Action · SFDR non renseignée

### Identité

| | |
|---|---|
| Code ISIN | `FR0014003TT8` |
| Société de gestion | n.c. |
| Nature juridique | Action |
| Classification SFDR | non renseignée |
| Avenant spécifique | non |
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -28,84% |
| **Finale (A − E)** | **-29,37%** |
...
`DE0007164600` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -11,83% |
| **Finale (A − E)** | **-12,49%** |
