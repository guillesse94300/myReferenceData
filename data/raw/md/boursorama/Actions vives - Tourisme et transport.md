...
|---|---|---|---|---|---|---|
| `FR0000120404` | ACCOR | n.c. | n.c. | 1,74% | n.c. | non renseignée |
| `FR001400J770` | AIR FRANCE - KLM | n.c. | n.c. | 41,29% | n.c. | non renseignée |
| `FR0013451333` | FDJ UNITED | n.c. | n.c. | -37,01% | n.c. | non renseignée |
| `FR0000121220` | SODEXHO ALLIANCE SA | n.c. | n.c. | -45,48% | n.c. | non renseignée |

---
## ACCOR

`FR0000120404` · n.c. · Action · SFDR non renseignée
...
| Classification d'actif | Tourisme et transport (annexe IB SwissLife (par ISIN)) |
...
| Nette de l'unité de compte (C = A − B) | 2,51% |
| **Finale (A − E)** | **1,74%** |
...
`FR001400J770` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | 42,36% |
| **Finale (A − E)** | **41,29%** |
...
`FR0013451333` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -36,54% |
| **Finale (A − E)** | **-37,01%** |
...
`FR0000121220` · n.c. · Action · SFDR non renseignée
...
|---|---|
| Brute de l'actif (A) | n.c. |
| Nette de l'unité de compte (C = A − B) | -45,07% |
| **Finale (A − E)** | **-45,48%** |
